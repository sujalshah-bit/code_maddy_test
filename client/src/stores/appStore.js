...
const createStore = (set, get) => {
  ...
  return {
    ...
    actions: {
      ...
      setIsMobileMenuOpen: createSetter('isMobileMenuOpen'),
      setDrawing: {
      ...
      setDimension: {
        setIsMobile: createSetter('dimension.isMobile'),
        setWidth: createSetter('dimension.width'),
        setHeight: createSetter('dimension.height')
      },
      setErrors: {
